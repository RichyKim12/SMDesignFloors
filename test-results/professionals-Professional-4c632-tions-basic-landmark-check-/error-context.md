...
- Name: professionals.spec.js >> Professionals Form — Page load >> has no detectable WCAG violations (basic landmark check)
- Location: tests\professionals.spec.js:56:3
